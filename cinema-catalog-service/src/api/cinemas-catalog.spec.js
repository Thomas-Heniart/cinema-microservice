...
describe('Cinema catalog API', () => {
  ...
  let testRepo = {
    getCinemasByCity (cityId) { return Promise.resolve(testCinemasCity) },
    getCinemaById (cinemaId) { return Promise.resolve(testCinemaId) },
    getCinemaScheduleByMovie (cinemaId, movieId) { return Promise.resolve(testSchedulesMovie) }
  }
  ...
  it('can return cinema by cityId', (done) => {
    const location = {
  ...
  it('can return cinema by id', (done) => {
    const cinemaId = '588ac3a02d029a6d15d0b5c4'
    request(app)
  ...
  it('can return schedules for cinema and movie', (done) => {
    request(app)
